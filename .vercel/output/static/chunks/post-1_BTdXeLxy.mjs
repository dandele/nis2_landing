const id = "fr/post-1.md";
						...
						new Proxy({"src":"/_astro/jacob.BfQgWSmi.avif","width":320,"height":320,"format":"avif","fsPath":"/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/jacob.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/jacob.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/jacob.avif");
							return target[name];
						}
					})
					,authorImageAlt:"Avatar Description",pubDate:new Date(1707177600000),cardImage:
						new Proxy({"src":"/_astro/post-1.BI8NM3Uo.avif","width":1500,"height":1001,"format":"avif","fsPath":"/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/post-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/post-1.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/images/blog/post-1.avif");
							return target[name];
						}
					})
					,cardImageAlt:"Top view mechanical tools arrangement",readTime:4,tags:["outils","construction","flux de travail"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/dandele/Desktop/ 1 - Roles/NIS2/NIS2/src/content/blog/fr/post-1.md",
							rawData: undefined,
						};
